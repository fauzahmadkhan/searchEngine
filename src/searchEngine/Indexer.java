...
public class Indexer {
    ...
    Indexer() {
        try {
            BufferedReader countReader = new BufferedReader(new FileReader(System.getProperty("user.dir") + "\\src\\searchEngine\\counter.txt"));
            String counterData;
    ...
    public void createInMemoryInvertedIndex() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(System.getProperty("user.dir") + "\\src\\searchEngine\\doc_index.txt"))) {
            String line;
            int lineNo = 1;
    ...
    public void writeInvertedIndexToFile() {
        try {
            ...
            for (int i = 1; i < totalTerms + 1; i++) {
                ...
                termIndexwriter.write(i + "\t" + this.invertedIndex[i].docIdOffsetIdpairs.size());
                termIndexwriter.write("\t" + this.invertedIndex[i].totalNumberOfDocumentsInWhichTheTermAppeared);
